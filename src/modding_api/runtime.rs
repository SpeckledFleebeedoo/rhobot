...
impl Class {
    pub fn to_embed(&self, data: &Data) -> serenity::CreateEmbed {
        ...
        self.common
            .create_embed(data)
            .author(
                serenity::CreateEmbedAuthor::new("Class")
...
impl Event {
    pub fn to_embed(&self, data: &Data) -> serenity::CreateEmbed {
        ...
        self.common
            .create_embed(data)
            .author(
                serenity::CreateEmbedAuthor::new("Event")
...
impl Define {
    pub fn to_embed(&self, data: &Data) -> serenity::CreateEmbed {
        ...
        self.common
            .create_embed(data)
            .author(
                serenity::CreateEmbedAuthor::new("Define")
...
impl Concept {
    pub fn to_embed(&self, data: &Data) -> serenity::CreateEmbed {
        ...
        self.common
            .create_embed(data)
            .author(
                serenity::CreateEmbedAuthor::new("Concept")
...
pub async fn update_api_cache(cache: Arc<RwLock<ApiResponse>>) -> Result<(), Error> {
