...
use crate::{database, faq_commands, fff_commands, management, modding_api, mods, wiki_commands};
...
impl RhobotError {
    pub fn log(&self) {
        match &self {
            Self::FFF(ffferror) => match ffferror {
            ...
            Self::API(api_error) => match api_error {
            ...
            Self::Mod(mod_error) => match mod_error {
